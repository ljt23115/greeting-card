...
const Letter = memo(() => {
  ...
  const [letterUrl, setUrl] = useState(
    'pageMaterial/img/jieRan/letter/text_jieRan.png'
  )
    ...
    <LetterWrapper ref={letterRef}>
          ...
          <div className={classNames('letter', { animationLetter: isInView })}>
            ...
            <img
              className={classNames({
                animationImg: AnimSwitch,
                animationImg2: AnimSwitch
              })}
              src={letterUrl}
              alt=""
            />
      ...
      <div className="letter-lists">
        <img
          ...
          alt=""
          onClick={() =>
            imgClick('pageMaterial/img/jieRan/letter/text_jieRan.png')
          }
        />
        <img
          src="pageMaterial\img\patrick\envelope\envelope_close_patrick.png"
          alt=""
          onClick={() =>
